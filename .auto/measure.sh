...
gate bash -c 'grep -q "P3 baseline status: `READY`" docs/roadmap/erp-primitives.md && grep -q "Level 3" docs/roadmap/domain-maturity.md && rtk deno task check >/dev/null'

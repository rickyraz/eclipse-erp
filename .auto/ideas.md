...
- Release `accounting.revenue.post` into the action catalog only after Accounting can derive or verify the amount from a Sales-owned confirmed-order fact without creating a package cycle.
- Add a second genuinely Level 3 action provider before broad Process Studio runtime work.

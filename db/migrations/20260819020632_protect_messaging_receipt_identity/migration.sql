...
-- rationale: keep completed consumer receipt bindings immutable for duplicate suppression and replay safety
...
BEGIN
  IF OLD.tenant_id IS DISTINCT FROM NEW.tenant_id OR
    ...
    RAISE EXCEPTION USING
      ...
      MESSAGE = 'consumer receipt identity is immutable';
  END IF;
  RETURN NEW;
END;
$$;
...
ON messaging.consumer_receipts

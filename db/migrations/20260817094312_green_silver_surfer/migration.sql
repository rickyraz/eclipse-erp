...
-- rationale: prevent historical financial operations from being treated as verified TigerBeetle work without explicit evidence

ALTER TABLE "accounting"."financial_operations" ADD COLUMN "engine_verified" boolean DEFAULT false NOT NULL;--> statement-breakpoint

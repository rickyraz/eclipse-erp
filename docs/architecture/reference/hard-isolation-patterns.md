...
facts, while an activated financial profile follows ADR-0040. Therefore `celld` supports entity-level
coordination and recovery, while WorkloadCells, workload planes, and ResourceLeases protect command
resources from degradable workload traffic.
